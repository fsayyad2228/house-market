...
const EditListing = () => {
  ...
  //form submit and this code is use the time
  //Google map u can use because of google api key is paid
  const onSubmit = async (e, listingId) => {
    setLoading(true);
    e.preventDefault();
    ...
    if (geoLocationEnable) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyCWTCi0Lgumrd8Elkv8uHv8-UpAgMGCjrM`
      );
